...
const UI_TEXT = {
  vi: {
    ...
    sourcePublicNoteLabel: 'Mã nguồn công khai',
    sourcePublicNoteAuto: 'Trang khảo sát được cập nhật tự động qua liên kết triển khai giữa Vercel và repository mã nguồn.',
  ...
  en: {
    ...
    sourcePublicNoteLabel: 'Public source code',
    sourcePublicNoteAuto: 'This survey page is updated automatically via deployment linkage between Vercel and the source repository.',
