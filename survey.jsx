...
const UI_TEXT = {
  vi: {
    ...
    sourcePublicNote: 'Trang khảo sát được cập nhật tự động nhờ liên kết triển khai giữa Vercel và kho mã nguồn, được công khai tại: https://github.com/thienannguyen-cv/AI-maturity-survey.',
